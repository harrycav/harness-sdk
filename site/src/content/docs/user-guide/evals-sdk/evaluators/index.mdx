...
**[StructuredOutput](structured_output_evaluator.md)**

- **Level**: OUTPUT_LEVEL
- **Purpose**: Field-level scoring of structured output against ground truth
- **Use Case**: Extraction tasks where partial correctness matters and you need to know which field failed
